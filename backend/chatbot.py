...
async def ask_local_ai(message: str, history: list[dict[str, str]] | None = None) -> dict[str, Any]:
    ...
    prompt = (
        ...
        "Treat job titles like Python Developer, Cyber Security Engineer, AI Engineer, Data Analyst, "
        "Full Stack Developer, DevOps Engineer, Product Manager, HR Recruiter, Designer, Founder, "
        "Sales Manager, Cloud Engineer, Security Analyst, QA Engineer, and similar roles as normal professional roles. "
        "When the user asks for a message for a role, write a useful message tailored to that role. "
        "Do not refuse only because a role contains words like security, cyber, cloud, data, AI, automation, or engineer. "
        "Only refuse requests that ask for hacking, credential theft, bypassing security, impersonation, spam, deception, "
        "scraping abuse, or evading LinkedIn limits. "
